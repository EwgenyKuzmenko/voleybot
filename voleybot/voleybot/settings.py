"""
Django settings for voleybot project.
...
INSTALLED_APPS = [
    ...
    'voleybotapp.apps.VoleybotappConfig',
]
...
WSGI_APPLICATION = 'voleybot.wsgi.application'
